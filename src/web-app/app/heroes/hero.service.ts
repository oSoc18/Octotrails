...
export class HeroService {
  ...
  getHeroes(): Observable<Hero[]> {
    return this.http
      .get<Object[]>(this.heroesUrl)
      .pipe<Hero[]>(
        map<Object[], Hero[]>(heroes =>
          heroes.map<Hero>(hero => new Hero(hero['id'], hero['name']))
        )
      );
  }
  ...
  getHero(id: string): Observable<Hero> {
    ...
    return this.http
      .get<Object>(this.heroesUrl + '/' + id)
      .pipe<Hero>(
        map<Object, Hero>(hero => new Hero(hero['id'], hero['name']))
      );
  }
  ...
  searchHeroes(text: string): Observable<Hero[]> {
    return this.http
      .get<Object[]>(this.heroesUrl + '?name=' + text)
      .pipe<Hero[]>(
        map<Object[], Hero[]>(heroes =>
          heroes.map<Hero>(hero => new Hero(hero['id'], hero['name']))
        )
