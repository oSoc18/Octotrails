...
@NgModule({
  ...
  declarations: [PageNotFoundComponent, RangeValidatorDirective, NumberComponent,
  BooleanComponent,
  MultipleComponent,
  StringComponent],
  exports: [PageNotFoundComponent, RangeValidatorDirective, MatDesignModule, NumberComponent,
  BooleanComponent,
  MultipleComponent,
  StringComponent]
})
